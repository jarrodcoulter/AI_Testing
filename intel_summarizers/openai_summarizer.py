...
researcher = autogen.AssistantAgent(
    ...
    Your final output contains a summary of the article and a section below for each IOC type. Below the Type, include the IOCS of that type separated by a comma, there should be no other formatting, no ` or . If the URLs or domains have been 'defanged' add back the 'http' and remove any brackets. 
